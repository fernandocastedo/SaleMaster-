...
import org.example.salesmaster.common.ApiResponse;
 ...
 * ------------------------------------------------------------
 * Centraliza el manejo de errores de toda la aplicación SalesMaster.
 *
...
public class GlobalExceptionHandler {
     ...
     * Ejemplo: buscar un cliente, producto o pedido inexistente
     */
